...
This example was generated by running the release binary with this exact seed:

```bash
.build/release/ork-swift-new \
  --input .tmp-readme-example/input \
  --output .tmp-readme-example/output \
  --rename-files \
  --rename-private-functions \
  --manifest .tmp-readme-example/manifest.json \
...
<table>
<tr>
<th>Before: <code>Sources/App/ProfileCoordinator.swift</code></th>
<th>After: <code>Sources/App/S_ace3a40d9bf6.swift</code></th>
</tr>
<tr>
<td>
...
struct ProfileCoordinator {
    func buildTitle(for name: String) -> String {
        let sanitized = f_97c0f5600c47(name)
        return f_bbdaff57b8d0(sanitized)
    }

    private func f_97c0f5600c47(_ value: String) -> String {
        value.trimmingCharacters(in: .whitespacesAndNewlines)
    }

    private func f_bbdaff57b8d0(_ value: String) -> String {
        "Profile: \(value)"
    }
}</code></pre>
</td>
